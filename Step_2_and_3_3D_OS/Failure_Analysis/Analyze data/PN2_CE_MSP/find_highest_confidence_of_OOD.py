...
tar1_MSP_scores_10_highest_keys = np.argsort(tar1_scores)[-10:]
tar1_MSP_scores_10_highest_data = []

for i in tar1_MSP_scores_10_highest_keys:
    ...
    tar1_MSP_scores_10_highest_data.append(pcd)
