...
def eval_ood_PointNet_CE_Euclidean_norm(opt, config):
    ...
    save_data_and_scores(id_loader, ood1_loader, ood2_loader, src_labels, tar1_labels, tar2_labels, src_MLS_scores, tar1_MLS_scores, tar2_MLS_scores, "PN2_subarcface", "MLS", opt.src, opt.corruption)
